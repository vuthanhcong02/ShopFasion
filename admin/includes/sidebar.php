...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
    <div class="sidebar-brand-text mx-3">Xin chào Admin <sup></sup></div>
</a>
...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Thông tin quản trị:</h6>
            <a class="collapse-item" href="categories.php">Loại danh mục</a>
            <a class="collapse-item" href="products.php">Sản phẩm</a>
            <a class="collapse-item" href="./category/categoryMa.php">Bài viết</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    <a class="nav-link" href="charts.html">
        ...
        <span>Quản trị thông tin</span></a>
</li>
