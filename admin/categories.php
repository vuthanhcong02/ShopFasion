    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Thông tin danh mục</h1>
                    ...
                    <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="EditCategory.php?id=<?php echo ($row['id']) ?>" class="btn btn-warning">Sửa</a>
                                <a onclick="return confirm('Ban co muon xoa khong ?');" href="deleteCategory.php?id=<?php echo ($row['id']) ?>" class="btn btn-danger">Xóa</a>
                            </td>
