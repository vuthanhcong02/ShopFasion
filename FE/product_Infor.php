    ...
    <div class="container p-2 mt-5 ">
       <div class="row d-flex justify-content-center align-items-center">
            <div class="col p-2 d-flex justify-content-center align-items-end">
                <img src="../admin/product/img/adidas.jpeg" alt="">
            </div>
            <div class="col p-2 d-flex justify-content-between align-items-start flex-column">
              <div class="">
                   <div class="mb-3 d-flex flex-column justify-content-center align-content-center">
                        ...
                        <div class="">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus excepturi natus eligend</div>
                   </div>
                   <div class="mb-3 d-flex flex-column">
                       <p class="fs-6 fw-bold">Mô tả : </p>
                       <p class="mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem sunt repellat ipsam dolorem tenetur non sit hic aperiam consequatur aspernatur, quisquam reiciendis possimus illum consectetur cupiditate alias culpa necessitatibus debitis.</p>
                   </div>
              </div>
                <div class="d-flex justify-content-center align-items-center mb-3">
                    <p class="fs-6 fw-bold">Giá : </p>
                    <p style="margin-left: 50px;">100000000000</p>
                </div>
                <div class="d-flex justify-content-center align-items-center mb-3">
